...
| Durable App Server sessions | [#115](https://github.com/clockgrove/factory/issues/115) | Runtime source integrated: exact immutable session identity, terminal recovery without another model turn, lifecycle and complete-usage accounting. Running / session lane: finish the installed WSL2 terminal-recovery qualification scenario. [Unsupported cold repair turns](CODEX-APP-SERVER-SESSIONS.md) remain an explicit provider boundary, not a claim of complete cold-turn usage. |
| Generic large-file handling | [#116](https://github.com/clockgrove/factory/issues/116), [#117](https://github.com/clockgrove/factory/issues/117), [#118](https://github.com/clockgrove/factory/issues/118) | Source integrated: LFS/tooling, manifests, streamed content, durable upload recovery, cache ownership, and exact local/sandbox continuation using original accounting and validation allowances. Running / artifact lane: close the disk-admission failure gap so missing collection evidence cannot authorize replacement. Written regressions remain unrun. |
