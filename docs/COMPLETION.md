...
| Scheduling and priority — [#76](https://github.com/clockgrove/factory/issues/76), [#77](https://github.com/clockgrove/factory/issues/77), [#123](https://github.com/clockgrove/factory/issues/123) | Code then testing / throughput and scheduling owners | [#218](https://github.com/clockgrove/factory/issues/218) removes redundant reads and corrects qualifier timing coupling and progress wakeups. Next: adapt that work to the completed #219 production authority model. Ordinary throughput and injected failures are separate scenarios. Preserve prior results; corrected acceptance never relabels historical evidence. Pressure, real lease contention and Priority edits remain required. | Ready to resume on merged source |
