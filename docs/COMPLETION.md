...
| Generic large-file handling | [#116](https://github.com/clockgrove/factory/issues/116), [#117](https://github.com/clockgrove/factory/issues/117), [#118](https://github.com/clockgrove/factory/issues/118) | Running / coordinator + artifact lane. Pinned LFS detection, verified local hydration, compiler tool requirements and collect-before-cleanup checkpoints are integrated as source. Finish consumer wiring, manifests, streamed transport and exact no-reexecution recovery; written regressions remain unrun. |
