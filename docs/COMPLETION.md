...
| --- | --- | --- | --- |
| Mutation telemetry attribution — [#199](https://github.com/clockgrove/factory/issues/199) | Code / reporting | [#200](https://github.com/clockgrove/factory/pull/200) merged: process-local counters are scoped separately, current header quota is retained, and absent run measurements are unavailable. Focused acceptance passed; changed runtime awaits the next coordinated candidate installation. | Code complete |
| Large files — [#123](https://github.com/clockgrove/factory/issues/123) | Code then testing / large-file command correction | [#203](https://github.com/clockgrove/factory/issues/203) fixes a fixture validation recipe rejected before worker execution. Next: reviewed correction, then matching installed LFS/manifests/transfer scenarios at the coordinated candidate boundary. | Running |
| Durable sessions — [#123](https://github.com/clockgrove/factory/issues/123) | Testing / retained session evidence | [#202](https://github.com/clockgrove/factory/issues/202) / [#204](https://github.com/clockgrove/factory/pull/204) corrected observed-stop qualifier semantics. Next: read-only final session, merge and resource proof reconciliation without replacement model work. Preserve original failure and candidate identity; correction alone is not a session pass. | Running |
