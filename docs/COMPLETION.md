...
Their correction and retained-work recovery are the current critical path.
...
| Installed continuation corrections | [#124](https://github.com/clockgrove/factory/issues/124), [#125](https://github.com/clockgrove/factory/issues/125) | Code / integration owner: strict cooldown parsing and authenticated foreground graph-base correction implemented and reviewed; affected checks pass. Preserve [original failure, partial pressure proof and independent cleanup](release-evidence/wsl2-pressure-original-failure-2026-09-06.json). Next: integrated corrected-candidate checks, matching artifact and supported recovery retaining the first merge and second root output. |
