...
| --- | --- | --- |
| Same-host multi-Objective and regular-PR concurrency | [#113](https://github.com/clockgrove/factory/issues/113), [#114](https://github.com/clockgrove/factory/issues/114) | Runtime source integrated: fair shared capacity, concurrent regular work, pinned compilation and exact peer/sibling integration. Running / concurrency lane: finish genuine-concurrency qualifier contract fixtures, then integrated review/checks/PR acceptance. |
...
| Generic large-file handling | [#116](https://github.com/clockgrove/factory/issues/116), [#117](https://github.com/clockgrove/factory/issues/117), [#118](https://github.com/clockgrove/factory/issues/118) | Source integrated: LFS/tooling, manifests, streamed content, durable upload recovery and operation-owned cache leases. Running / artifact integration lane: finish exact local/sandbox retained-output continuation and focused regressions; no replacement worker. Written tests remain unrun. |
