...
| --- | --- | --- |
| Integrated candidate corrections | [#119](https://github.com/clockgrove/factory/issues/119) | Running / parallel correction lanes: strict contracts and cache-race fixes integrated; finish object-only compatibility and successor-recovery corrections, then affected checks and the next stable integrated gates. Original full-run failures and the explicitly stopped successor worker are retained; no full-suite pass is claimed. |
| Same-host multi-Objective and regular-PR concurrency | [#113](https://github.com/clockgrove/factory/issues/113), [#114](https://github.com/clockgrove/factory/issues/114) | Source complete and integrated, including fair shared capacity, concurrent regular work, pinned compilation, exact peer/sibling integration and genuine-concurrency qualifier fixtures. Concurrency lane completed / waiting for final integrated checks and PR acceptance. |
| Durable App Server sessions | [#115](https://github.com/clockgrove/factory/issues/115) | Source complete and integrated, including exact session identity, terminal recovery without another model turn, complete-usage accounting and the deterministic installed WSL2 recovery scenario. Session lane completed / waiting for coordinated checks and PR acceptance. [Unsupported cold repair turns](CODEX-APP-SERVER-SESSIONS.md) remain an explicit provider boundary, not a claim of complete cold-turn usage. |
| Generic large-file handling | [#116](https://github.com/clockgrove/factory/issues/116), [#117](https://github.com/clockgrove/factory/issues/117), [#118](https://github.com/clockgrove/factory/issues/118) | Source complete and integrated: LFS/tooling, manifests, streamed content, durable upload recovery, cache ownership, and exact local/sandbox continuation using original accounting and validation allowances. Disk-admission failure now refuses unknown replacement, including failure of the first collection-marker write. Artifact lane completed / waiting for coordinated checks and PR acceptance. |
...
| Representative compiler/chat evaluation | [#111](https://github.com/clockgrove/factory/issues/111), [#112](https://github.com/clockgrove/factory/issues/112) | Corpus code written and integrated: five executable projects, twelve selection cases and bounded production-contract consumers. Regression execution/PR acceptance remain; actual compiler/agent behavior is #112 after all implementation. |
...
| Supplied-snapshot replay interface | [#103](https://github.com/clockgrove/factory/issues/103) | Source integrated / waiting for final candidate checks and PR acceptance. Bounded pinned admission inputs are exposed through MCP/CLI and remain distinguished from authenticated history. |
| Pressure/cooldown qualification scenario | [#104](https://github.com/clockgrove/factory/issues/104), [#76](https://github.com/clockgrove/factory/issues/76) | Source integrated / waiting for final candidate checks and PR acceptance. Pressure/cooldown observation and readmission-deadline correction are written; no changed-candidate live pass or whole-matrix claim. |
| Hierarchical capacity and queued-reason correctness | [#105](https://github.com/clockgrove/factory/issues/105), [#106](https://github.com/clockgrove/factory/issues/106) | Source integrated / waiting for final candidate checks and PR acceptance. Ancestor CPU/memory limits and genuine queued-reason transitions are implemented; regression cases are written, not executed. |
