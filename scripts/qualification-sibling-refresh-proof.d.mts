...
export function assertQualificationCheckpoint(value: unknown, request: { ref: string; path: string; maxBytes: number }, parents: string | string[]): Record<string, unknown>;
