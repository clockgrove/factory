...
export function assertNativeFallbackCapability(proof: unknown, input: {
  repository: string;
  actor: { id: number; login: string };
}): void;
export function nativeFallbackQualification(env: Record<string, string | undefined>): Record<string, unknown> | null;
...
export function main(env?: Record<string, string | undefined>, run?: (qualification: Record<string, unknown>) => Promise<void>): Promise<void>;
