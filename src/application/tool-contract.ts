...
const READ: ApplicationToolAnnotations = {
  readOnlyHint: true,
  destructiveHint: false,
  idempotentHint: true,
  openWorldHint: true,
};
const WRITE: ApplicationToolAnnotations = {
  readOnlyHint: false,
  destructiveHint: false,
  idempotentHint: true,
  openWorldHint: true,
};
const DESTRUCTIVE: ApplicationToolAnnotations = {
  readOnlyHint: false,
...
export const APPLICATION_TOOL_DEFINITIONS: ReadonlyArray<
  readonly [string, ApplicationOperation, ApplicationToolAnnotations]
> = [
  ["factory_doctor", "doctor", READ],
  ["factory_plan", "plan", READ],
  ["factory_status", "status", READ],
  ["factory_explain", "explain", READ],
  ["factory_activate", "activate", WRITE],
  ["factory_pause", "pause", WRITE],
  ["factory_resume", "resume", WRITE],
  ["factory_drain", "drain", WRITE],
  ...
  ["factory_controller_restart", "controller-restart", WRITE],
  ["factory_controller_status", "controller-status", READ],
  ["factory_controller_install", "controller-install", WRITE],
