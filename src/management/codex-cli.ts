...
export function renderCompilerProposalPrompt(
  ...
  return [
    ...
    "An objectives result must provide independently reviewable outcomes, concrete acceptance, owned scope, prerequisite outputs, completion acceptance IDs, complete parent-obligation dispositions, and evidence-bearing triggers. It only proposes Objectives; it does not create issues, activate runs, expand policy, or imply completion. A clarification result must ask concrete questions and bind them to affected obligations.",
